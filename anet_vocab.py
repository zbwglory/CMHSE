...
def build_vocab(data_path, data_name, jsons, threshold):
    ...
    f_glove = open('/data1/bwzhang/DataStorage/glove.840B.300d.txt','r')
    glove = {}
    ...
    for path in jsons[data_name]:
        ...
        for i, video in enumerate(dic.keys()):
            for sen in dic[video]['sentences']:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', default='anet',
                        help='coco|anet')
